...
<body>
    ...
    <form action="adicionar_livro.php" method="post">
       ...
       <input type="text" id="titulo" name="titulo" placeholder="Insira o título" required><br><br>
        ...
        <input type="number" id="ano" name="ano" placeholder="Ano de publicação" required><br><br>

        <label for="isbn">ISBN:</label>
        <input type="number" id="isbn" name="isbn" placeholder="Insira o código ISBN" require><br><br>
        ...
        <input type="file"  id="capa" name="capa" require><br><br>
